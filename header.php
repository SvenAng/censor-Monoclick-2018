...
<div class="header" data-toggle="affix" id="header">
	<a id="header-logo" href="/">
		<div class="headerlogo-container">
		<img class="header-logo" src="<?= get_template_directory_uri(); ?>/assets/Censor_logo.png">
	</a>
    <a href="javascript:void(0);" id="icon" href="#icon" onclick="burgerFunction()" class="fa fa-bars affix"></a>
</div><div class="extra">
	<?php
		$args = array(
